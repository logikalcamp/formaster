            ...
            <Setting>
                {
                    ...
                    <DropDownSettings callback={clm}>
                        <Div>
                            ...
                            <input type="text" placeholder="הזן את הכותרת " value={label} onChange={(e)=>setLabel(e.target.value)}/>
                        </Div>
                        <Div>
                            <label>שם משתנה בURL</label>
                            <input type="text" placeholder="שם הפרמטר בURL" value={urlPar} onChange={(e)=>setPar(e.target.value)}/>
                        </Div>
                        <Div>
                            ...
                            <button onClick={()=>{
                                ...
                                d.formCase.key = urlPar
                                d.formCase.label = label
